...
// Data decorativa no topo do card: "MS-2026-MAY-18"
const NOW        = new Date();
const TODAY_ISO  = NOW.toISOString().split('T')[0];
const MONTH_ABBR = ['JAN','FEB','MAR','APR','MAY','JUN','JUL','AUG','SEP','OCT','NOV','DEC'];
const DECO_DATE  = `MS-${NOW.getFullYear()}-${MONTH_ABBR[NOW.getMonth()]}-${String(NOW.getDate()).padStart(2, '0')}`;
      ...
      >
        ...
        >
          ...
          <View style={styles.passportCard}>
            ...
            <Text style={styles.decoDate}>{DECO_DATE}</Text>
